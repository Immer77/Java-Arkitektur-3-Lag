...
public class EmployeePane extends GridPane {
	...
	public EmployeePane() {
		...
		Label lblEmploymentYear = new Label("Employment Year:"); //Tester her til
		this.add(lblEmploymentYear,1,5);

		txfEmploymentYear = new TextField();
		this.add(txfEmploymentYear,2,5);
		txfEmploymentYear.setEditable(false); // Her
	...
	public void updateControls() {
		...
		if (employee != null) {
			...
			if (employee.getCompany() != null) {
				...
				txfEmploymentYear.setText("" + employee.getEmploymentYear()); //Tester her
			} else {
				txfCompany.clear();
				txfSalary.clear();
